# hospital interface using tkinter
...
def lst_doc():
    ...
    l = ["Dr. S.Das","Dr. Paul","Dr. Kumar","Dr. Khan","Dr. Kohli","Dr. Singh","Dr. Sidharth","Dr. Tendulkar","Dr. Virat","Dr. Shikha",'Dr. Irfan','Dr. John',
       'Dr. Sanjay','Dr. Shahid']
...
label = Label(root,text = "HOSPITAL",font = "arial 40 bold",bg = 'light blue')
